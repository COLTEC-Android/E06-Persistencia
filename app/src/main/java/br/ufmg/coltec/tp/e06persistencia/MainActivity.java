...
public class MainActivity extends AppCompatActivity {
    ...
    public Button TiraFotoBtn;
    public Button SalvarFotoBtn;
    public ImageView VerFoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SalvarFotoBtn = findViewById(R.id.salva_btn);
        TiraFotoBtn = findViewById(R.id.tira_Foto_Btn);
        VerFoto = findViewById(R.id.foto);

        getLastAccess();
        setLastAccess();

        TiraFotoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        SalvarFotoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                savePhotoFile(((BitmapDrawable)VerFoto.getDrawable()).getBitmap());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == FOTO_CODE && resultCode == Activity.RESULT_OK) {
            ...
            VerFoto.setImageBitmap(photo);
        }
    }

    private void savePhotoFile(Bitmap photo) {
        File file = new File(getBaseContext().getExternalFilesDir(null), "Foto.png");
